...
#a Globals
riscv_regression_dir = "../riscv-tests-built/isa/"
    ...
    def check_memory(self, reason):
        for a in self.memory_expectation:
            ...
            for i in range(len(e)):
                d.append(self.read_memory("dmem",address/4+i))
                pass
...
class riscv_minimal(simple_tb.base_test):
    #def test_one(self): self.do_test_run(riscv_minimal_test_hw(c_riscv_minimal_test_one()), num_cycles=3*1000)
    pass
