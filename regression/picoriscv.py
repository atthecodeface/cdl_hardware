...
#a Test classes
#c c_picoriscv_test_base
class c_picoriscv_test_base(simple_tb.base_th):
    mif_filename = None
    dump_filename = None
    base_address = 0
    test_memory = "dmem"
...
class c_picoriscv_test_dump(c_picoriscv_test_base):
    ...
    def __init__(self, dump_filename, test_memory="dut.mem", **kwargs):
        ...
        c_picoriscv_test_base.__init__(self, **kwargs)
        pass
    pass

#a Hardware classes
#c picoriscv_test_hw
class picoriscv_test_hw(simple_tb.cdl_test_hw):
    """
...
#c picoriscv
class picoriscv(simple_tb.base_test):
    pass

#c Add tests to picoriscv
tests = {"or":("rv32ui-p-or.dump",3*1000),
         ...
         "fence_i":("rv32ui-p-fence_i.dump",3*1000),
...
for tc in tests:
    ...
    def test_fn(c, tf=tf, num_cycles=num_cycles):
        c.do_test_run(picoriscv_test_hw(c_picoriscv_test_dump(dump_filename=tf)), num_cycles=num_cycles)
        pass
    setattr(picoriscv, "test_"+tc, test_fn)
    pass
