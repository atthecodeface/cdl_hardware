...
SRAM_WRAPPER(256, 40, 0)
SRAM_WRAPPER_DP(16384, 48)
SRAM_WRAPPER_DP(2048, 32)
SRAM_WRAPPER_DP(512, 64)
SRAM_WRAPPER_DP(512, 32)
...
srams__init( void )
{
    ...
    SRAM_REGISTER(256, 40, 0);
    SRAM_REGISTER_DP(16384, 48);
    SRAM_REGISTER_DP(2048, 32);
    SRAM_REGISTER_DP(512, 32);
    SRAM_REGISTER_DP(512, 64);
